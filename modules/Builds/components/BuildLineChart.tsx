...
import getBuildLineChartConfig from '../services/getBuildLineChartConfig';
  ...
  return (
    <div className="bg-white rounded-md overflow-hidden relative" ref={wrapperRef}>
      <div className="px-30 pt-15 flex items-center">
        {title} {unit ? <span className="text-tas-400 text-size-12">({unit})</span> : ''}{' '}
      ...
      <div className="w-11/12 pb-30 m-auto overflow-hidden">{contentDom}</div>
    </div>
  );
};
